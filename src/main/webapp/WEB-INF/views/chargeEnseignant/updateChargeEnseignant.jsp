						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<f:form modelAttribute="chargeenseignant" action="${enregistrer}" method="Post" role="form">
									...
									<f:hidden path="nbreAnsenceTdTot"/>
									<f:hidden path="nbreAnsenceTpTot"/>
									<f:hidden path="SalaireNet"/>
									<f:hidden path="SalaireBrut"/>
									...
									<div class="form-group">
										...
										<f:select path="semestre.idSemestre" class="form-control" items="${Semestres}" itemLabel="description" itemValue="idSemestre"></f:select>
									</div>
