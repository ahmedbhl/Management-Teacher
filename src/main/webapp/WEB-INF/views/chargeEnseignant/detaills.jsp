		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							<c:url value="/chargeEnseignants/" var="chargeEnseignants"></c:url>
							<li><a href="${chargeEnseignants}"><i class="fa fa-arrow-left  ">&nbsp;Retour</i></a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Liste des Seances Par Semestre de l'enseignant</div>
							<!-- /.panel-heading -->
