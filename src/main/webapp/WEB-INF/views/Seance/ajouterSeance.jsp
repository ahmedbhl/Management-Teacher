	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Séances</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
							...
							<div class="panel-body">
								...
								<f:form modelAttribute="seance" action="${enregistrer}" method="Post" role="form">
									...
									<div class="form-group">
										<label>Nom de Séance</label>
										<f:input path="nomSeance" class="form-control" placeholder="Nom de Séance" />
									...
									<div class="form-group">
										...
										<f:select path="chargeEnseignant.idChargeEnseignant" items="${chargeEnseignants}" itemValue="idChargeEnseignant" itemLabel="enseignant.fullName" class="form-control" ></f:select>
										<f:errors path="chargeEnseignant.idChargeEnseignant" class="text-danger" />
									</div>
									
									<div class="form-group">
										<label>Date de Séance</label>
										<div class='input-group date' id='datetimepicker10'>
										<f:input  path="date" size="16" type="text" class="form-control" placeholder="Date de Séance" readonly="true" id="form_datetime" />
									...
									<div class="form-group">
										...
										<label class="checkbox-inline"><f:checkbox path="heureSeances" value="S1" />S1</label>
										<label class="checkbox-inline"><f:checkbox path="heureSeances" value="S2" />S2</label>
										<label class="checkbox-inline"><f:checkbox path="heureSeances" value="S3" />S3</label>
										<label class="checkbox-inline"><f:checkbox path="heureSeances" value="S4" />S4</label>
										<label class="checkbox-inline"><f:checkbox path="heureSeances" value="S5" />S5</label>
										<label class="checkbox-inline"><f:checkbox path="heureSeances" value="S6" />S6</label>
										<br><f:errors path="heureSeances" class="text-danger" />
									</div>
													
									<div class="form-group">
										<label>Prèsent(e)&nbsp;&nbsp;</label>
